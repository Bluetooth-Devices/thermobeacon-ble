...
AIR_MONITOR = BluetoothServiceInfo(
    name="ThermoBeacon Air Monitor Lite",
    manufacturer_data={},
    service_uuids=[],
    address="aa:bb:cc:dd:ee:ff",
    rssi=-60,
...
CLOCK_LITE = BluetoothServiceInfo(
    name="ThermoBeacon BT Clock Lite",
    manufacturer_data={},
    service_uuids=[],
    address="aa:bb:cc:dd:ee:ff",
    rssi=-60,
...
QINGPING_DOOR_WINDOW = BluetoothServiceInfo(
    name="ThermoBeacon Door/Window Sensor",
    manufacturer_data={},
    service_uuids=[],
    address="aa:bb:cc:dd:ee:ff",
    rssi=-60,
...
def test_temp_rh_m():
    ...
    assert parsed == SensorUpdate(
        title="ThermoBeacon Temp RH M EEFF",
        devices={
            None: SensorDeviceInfo(
                name="ThermoBeacon Temp RH M EEFF",
                model="CGG1",
                manufacturer="ThermoBeacon",
                sw_version=None,
                hw_version=None,
